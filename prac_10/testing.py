...
def format_as_sentence(phrase : str):
    """Format a passed in phrase argument as a sentence.
    >>> format_as_sentence('hello')
    'Hello.'
    >>> format_as_sentence('It is an ex parrot.')
    'It is an ex parrot.'
    >>> format_as_sentence('PYTHON Is Cool')
    'Python is cool.'
    """
    sentence = phrase.capitalize()
    if not sentence.endswith("."): # Check if sentence ends with a full stop.
        sentence += "."
    return sentence
