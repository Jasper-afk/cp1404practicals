...
def main():
    ...
    for line in in_file:
        ...
        # Pointer Arithmetic is stored as a string (True/False) and a Boolean is needed
...
def using_namedtuple():
    ...
    Language = namedtuple('Language', 'name, typing, reflection, pointer_reflection, year')
    reader = csv.reader(in_file)  # use default dialect, Excel
